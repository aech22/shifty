// ============================================================
// Shifty v6 - Firebase リアルタイム同期版 [build:20260813-e785d22]
// ============================================================
console.log("[Shifty] app.js loaded: build 20260813-e785d22");
...
const AD={padding:"6px 11px",background:"rgba(255,71,87,.1)",border:"1px solid rgba(255,71,87,.25)",borderRadius:4,color:"#FF4757",fontSize:12,fontWeight:600,cursor:"pointer"};
