// ============================================================
// Shifty v6 - Firebase リアルタイム同期版 [build:20260926-7cc132c]
// ============================================================
console.log("[Shifty] app.js loaded: build 20260926-7cc132c");
...
function makeSettings(shopId){
  return{shopId,candidates:CAND_WEEKDAY,weekdayCandidates:{0:CAND_WEEKEND,6:CAND_WEEKEND},dateCandidates:{},templates:[],breakTimes:{weekday:[],sat:[],sun:[],holSat:[],holSun:[]},staffAttributes:{},staffTypeLimits:{employee:{name:STAFF_TYPE_LABELS.employee,daily:0,weekly:0,biweekly:0,monthly:0,customDays:0,customHours:0},parttime:{name:STAFF_TYPE_LABELS.parttime,daily:0,weekly:0,biweekly:0,monthly:0,customDays:0,customHours:0}},overtimeSettings:{byStaff:{}},staffNumbers:{},shopAbbrs:[],staffWorkplaces:{},positions:{kitchen:[],hall:[]},requiredPositions:{},staffPositions:{}};
}
