      ...
      <div style={{background:"var(--c-card)",borderBottom:"1px solid #E5E7EB",padding:"12px 16px"}}>
        <div style={{maxWidth:900,margin:"0 auto",display:"flex",alignItems:"center",justifyContent:"space-between",flexWrap:"wrap",gap:8}}>
          ...
          <div style={{display:"flex",gap:4,flexWrap:"wrap"}}>
            {[["periods","期間"],["staff","スタッフ"],["candidates","候補"],["submissions","提出一覧"],["mypage","マイページ"],["settings","設定"]].map(([id,l])=>(
      ...
      {acctLoading
        ...
        :acctEmailMode
          ...
          :<div style={{display:"flex",flexDirection:"column",gap:8}}>
            ...
            <button onClick={async()=>{setAcctLoading(true);setAcctError("");const r=await onSignInAndLinkApple();setAcctLoading(false);if(r?.error)setAcctError(r.error);else tt("✓ アカウントを連携しました");}}
              style={{width:"100%",padding:"12px",background:"#1C1C1E",border:"1px solid var(--c-border)",borderRadius:10,color:"white",fontSize:14,fontWeight:700,cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",gap:8}}>
